...
public class MyAdapterBluetooth extends BaseAdapter{
    ...
    public MyAdapterBluetooth(Context context, ArrayList<Game> games, Typeface typeface) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.fragment_listview_bluetooth, null);
        TextView textView_date = (TextView) view.findViewById(R.id.tv_flistviewbluetooth_date);
        TextView textView_mode = (TextView) view.findViewById(R.id.tv_flistviewbluetooth_mode);

        CheckBox checkBox = (CheckBox) view.findViewById(R.id.cb_flistviewbluetooth_check);
